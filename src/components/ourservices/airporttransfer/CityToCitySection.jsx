...
const TravelAgencyHotelSection = () => {
  const features = [
    {
      icon: <FiClock className="text-3xl text-gray-800" />,
      title: "Priority Guest Pickup",
      description:
        "Ensure your guests arrive on time with dedicated airport transfers.",
    },
    {
      icon: <FiCalendar className="text-3xl text-gray-800" />,
      title: "Flexible Scheduling",
      description:
        "Adjust bookings according to flight timings or guest requests.",
    },
    {
      icon: <MdEventSeat className="text-3xl text-gray-800" />,
      title: "Luxury Fleet",
      description:
        "Offer guests premium vehicles for comfort and convenience.",
    },
    {
      icon: <FiDollarSign className="text-3xl text-gray-800" />,
      title: "Corporate Billing",
      description:
        "Simplified invoicing and reporting for hotels and travel partners.",
    },
    {
      icon: <FiRefreshCcw className="text-3xl text-gray-800" />,
      title: "Reliable Service",
      description:
        "Professional chauffeurs track flights and ensure timely arrivals.",
    },
    {
      icon: <FiWifi className="text-3xl text-gray-800" />,
      title: "Guest Connectivity",
      description:
        "Wi-Fi and in-car amenities for your VIP guests.",
    },
  ];
    ...
    <section className="max-w-7xl mx-auto px-4 py-16 bg-gray-50">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-4xl font-bold text-black leading-tight">
          ...
          <span className="block text-gray-900 text-3xl md:text-4xl font-bold mt-2">
            Premium Guest Transfers Made Simple
          </span>
        </h1>
        <p className="text-gray-600 text-lg max-w-3xl mx-auto mt-4 leading-relaxed">
          Partner with Linkway Rides to provide seamless, reliable airport
          transfers for your guests. Enjoy priority dispatch, corporate billing,
