        ...
        <div className="flex-1 text-center lg:text-left">
          <div className="mb-8 lg:mb-10">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-4 lg:mb-5 leading-tight">
              Seamless Airport
              <span className="block text-[#F3B800] mt-2">Transfers at Your Fingertips</span>
            </h2>

            {/* Description */}
            <p className="text-gray-700 text-lg lg:text-xl max-w-2xl lg:pl-1 mb-2">
              Book, track, and manage your airport ride with professional chauffeurs—stress-free and on time.
            </p>

            {/* Sub features */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 lg:gap-4 mt-6">
              {['On-Time Pickup', 'Live Flight Tracking', 'Premium Vehicles', '24/7 Service'].map((feature, index) => (
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-3 rounded-xl shadow-lg">
                <img
                  ...
                  alt="Scan to download Airport Transfer App"
                  className="w-28 h-28"
                />
          ...
          <div className="relative">
            ...
            <div className="relative">
              <img
                ...
                alt="Airport Transfer App Interface"
              ...
              <div className="absolute -top-3 -right-3 bg-white px-3 py-1.5 rounded-full shadow-lg flex items-center gap-2 animate-bounce">
                ...
                <span className="text-xs font-semibold">Flight Tracking</span>
              </div>
