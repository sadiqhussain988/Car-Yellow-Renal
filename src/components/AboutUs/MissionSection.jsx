  ...
  return (
    <section className="relative py-10 px-6 md:px-20 bg-gradient-to-br from-slate-50 via-white to-slate-100 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-yellow-400/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-blue-400/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-32 bg-gradient-to-r from-transparent via-yellow-500/10 to-transparent rotate-45 animate-pulse"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 text-left">
          {/* Mission Card */}
          <div 
            className="group relative bg-white/80 backdrop-blur-sm p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-yellow-300/50 overflow-hidden"
            data-aos="fade-right"
          >
            {/* Shine Overlay */}
            ...
            <div className="absolute inset-0 opacity-5">
              <div className="absolute top-4 right-4 w-20 h-20 bg-yellow-500 rounded-full"></div>
              <div className="absolute bottom-4 left-4 w-16 h-16 bg-blue-500 rounded-full"></div>
            </div>
          ...
          {/* Vision Card */}
          <div 
            className="group relative bg-white/80 backdrop-blur-sm p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-blue-300/50 overflow-hidden"
            data-aos="fade-left"
            data-aos-delay="200"
          >
            {/* Shine Overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-50/30 to-transparent transform -skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 delay-200"></div>
            
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-5">
              <div className="absolute top-6 left-6 w-24 h-24 bg-blue-500 rounded-full"></div>
              <div className="absolute bottom-6 right-6 w-12 h-12 bg-yellow-500 rounded-full"></div>
            </div>
            ...
            {/* Bottom Accent */}
            <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-br from-yellow-500 to-yellow-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left delay-300"></div>
          </div>
        </div>
        ...
        <div className="mt-16" data-aos="fade-up" data-aos-delay="400">
          <div className="inline-flex items-center gap-4 bg-white/80 backdrop-blur-sm rounded-2xl px-5 py-2 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-700 font-semibold text-lg">
              ...
              <span className="text-yellow-600 font-bold">Book your journey with Linkway Rides today!</span>
            </p>
          </div>
        </div>
      </div>
