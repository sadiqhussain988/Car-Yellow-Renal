      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative group">
          <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
            ...
            {/* Border Glow */}
            <div className="absolute inset-0 rounded-2xl border border-gray-400/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>

          {/* Floating Accent Orbs */}
          <div className="absolute -top-4 -right-4 w-8 h-8 bg-gray-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200 shadow-lg"></div>
          <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gray-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-300 shadow-lg"></div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-4xl font-bold text-gray-900 leading-tight">
              Our <span className="text-gray-950">Story</span>
            </h2>
            <div className="w-20 h-1 bg-gray-950 rounded-full"></div>
          </div>
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <p className="text-lg">
              ...
              <span className="font-bold text-gray-900 bg-gray-200 px-1 rounded">
                Linkway Rides
              </span>{" "}
