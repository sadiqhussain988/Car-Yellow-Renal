      ...
      >
        ...
        >
          <div className="text-center mb-8" data-aos="fade-down">
            <h2 className="text-4xl font-bold text-gray-800 mb-3 bg-gradient-to-r from-gray-800 to-gray-800 bg-clip-text text-transparent">
            ...
            <p className="text-gray-600 text-lg">
              ...
              <Link
                to="/sign-up"
                className="text-[black] font-semibold hover:text-[#161615] transition-colors duration-300 cursor-pointer underline decoration-2 decoration-[black] hover:decoration-[#1b1b1a]"
              >
                Sign up
              </Link>
            </p>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="relative group" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="relative">
                <FaEnvelope className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg transition-colors duration-300 group-focus-within:text-[black]" />
                <input
                  type="email"
                  name="email"
                  className="w-full border-1 border-gray-200 bg-gray-50 p-3 pl-12 rounded-xl text-gray-800 focus:outline-none focus:border-[black] focus:bg-white transition-all duration-300 shadow-sm hover:border-gray-300"
            ...
            <div className="relative group" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="relative">
                <FaLock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg transition-colors duration-300 group-focus-within:text-[black]" />
                <input
                  type={showPassword ? "text" : "password"}
                  name="password"
                  className="w-full border-1 border-gray-200 bg-gray-50 p-3 pl-12 pr-12 rounded-xl text-gray-800 focus:outline-none focus:border-[black] focus:bg-white transition-all duration-300 shadow-sm hover:border-gray-300"
            ...
            >
              ...
              <Link
                to="/forgot-password"
                className="text-[black] font-semibold cursor-pointer text-sm hover:text-[#070707] transition-colors duration-300"
              >
                Forgot password?
              </Link>
            </div>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-[black] to-[black]"></div>
